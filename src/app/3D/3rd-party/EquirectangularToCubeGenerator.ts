...
import {
  ...
  CubeCamera,
  Mesh, NoBlending,
  PerspectiveCamera, RenderTarget,
  Scene, ShaderMaterial,
  UniformsUtils,
  WebGLRenderer, WebGLRenderTargetCube
} from "three";
...
export class CubemapGenerator {
  ...
  fromEquirectangular(texture, options): RenderTarget {
    options = options || {};
...
export const EquirectangularToCubeGenerator = ( () => {
